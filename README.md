...
```shell
  docker buildx build -t agorinenko/docker-extension-postgres:latest . --load
```

To install the extension, use `make install-extension` **or**:

```shell
  docker extension install agorinenko/docker-extension-postgres:latest
```
...
```shell
  docker extension dev ui-source agorinenko/docker-extension-postgres:latest http://localhost:3000
```

In order to open the Chrome Dev Tools for your extension when you click on the extension tab, run:

```shell
  docker extension dev debug agorinenko/docker-extension-postgres:latest
```

Each subsequent click on the extension tab will also open Chrome Dev Tools. To stop this behaviour, run:

```shell
  docker extension dev reset agorinenko/docker-extension-postgres:latest
```
...
```shell
docker extension update agorinenko/docker-extension-postgres:latest
```
...
```shell
docker extension rm agorinenko/docker-extension-postgres:latest
```
